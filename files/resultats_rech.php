...
<?php
	...
	if ($nbResultat==0) {
		echo "<div class=\"alert alert-danger no_resultats_text\"><i id=\"no_resultats_img\" class=\"fa fa-exclamation-triangle fa-3x\"></i>";?>
        <?=_("Votre objet")?> <strong>$mot_cle</strong> <?=_("n'a pas été trouvé ! Gardez confiance et venez revoir dans quelques jours")?> ...</div>
				...
				<div class=\"modal-dialog\">
					<div class=\"modal-content\">
						<div class=\"modal-header\">
							<button type=\"button\" class=\"close red-color\" data-dismiss=\"modal\">x</button>
						...
						<div class=\"modal-body row\">
							<div class=\"row\">
								...
								<div class=\"col-xs-12 col-sm-8 col-md-8 col-lg-8\">
									<div class=\"row\">
										<div class=\"col-md-12\"><label id=\"desc-obmod\">Objet :</label><label id=\"value-obmod\">".html_entity_decode($nvObjet->getNatureObjet())."</label></div>
										<div class=\"col-md-12\"><label id=\"desc-obmod\">Retrouvé vers : </label>".$nvObjet->getAddrObjet()."</div>
										<div class=\"col-md-12\"><label id=\"desc-obmod\">Ramassé par : </label>".$nvFinder->getPrenom()." ".$nvFinder->getNom()."</div>
										<div class=\"col-md-12\"><label id=\"desc-obmod\">Adresse : </label>".$nvFinder->getAddr()."</div>
										<div class=\"col-md-12\"><label id=\"desc-obmod\"l>Téléphone : </label>".$nvFinder->getTel()."</div>
                                        <div class=\"col-md-12\"><label id=\"desc-obmod\">Détails </label><label id=\"value-obmod\">".$nvObjet->getDetailsObjet()."kjhkjh kjhkjhkj hkjhghdgfc hg685465 jgfgh</label></div>
									</div>
								</div>
							</div>
							<div class=\"row\">
								<div class=\"col-sm-offset-4 col-md-offset-4 col-lg-offset-4 col-xs-12 col-sm-8 col-md-8 col-lg-8\">
									<div class=\"trait\"></div>	
